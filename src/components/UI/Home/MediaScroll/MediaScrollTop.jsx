    ...
    usableData && (
      <section className="relative bg-TMDB-950 group scroll-mt-16 w-full py-3 " id={id} {...props}>
        ...
        <div className="flex justify-between items-center">
          <div
            className="flex containerPadding items-center flex-row overflow-x-scroll mediaScrollBar w-full space-x-14  md:space-x-20"
            ref={scrollRef}
          >
            {usableData?.map((media, index) => (
              <div key={media.id} className="relative ml-[80px]">
                ...
                <img 
                  src={numbers[index]}
                  alt=""
                  className="absolute -left-[55%] md:-left-1/2 bottom-2" 
                />
